...
def linkedin():
    ...
    if choix == "O":
        for i in range(4001):
            lien = f"https://https://www.linkedin.com/in/{Fore.RED}{name}{i}"
            print(lien)
        ...
        if choix3 == "O":
            ...
            if choix4 == "O":
                ...
                while True:
                    ...
                    result2 = f"https://www.linkedin.com/in/{Fore.RED}{spam_account}"
                    print(result2)
            if choix4 == "N":
                ...
                for i in range(choix6):
                    ...
                    result1 = f"https://www.linkedin.com/in/{Fore.RED}{spam_account}"
                    print(result1)
        if choix3 == "N":
            print("Redirection...")
    if choix == "N":
        ...
        if choix2 == "com":
            link = f"https://www.linkedin.com/company/{Fore.RED}{name}"
            print(link)


        if choix2 == "user":
            user = f"https://www.linkedin.com/in/{Fore.RED}{name}"
            print(user)