...
def rechercher():
    ...
    if choix == "1":
        ...
        resultat = f"https://www.bing.com/search?q={Fore.RED}{recherce1}"
        print(resultat)
    ...
    if choix == "2":
        ...
        for i in range(recherche_starter):
            ...
            res = f"https://www.bing.com/search?q={Fore.RED}{recherche2}"
            print(res)
    ...
    if choix == "4":
        ...
        resultat3 = f"https://www.bing.com/search?q={Fore.RED}{recherche3}"
        print(resultat3)
